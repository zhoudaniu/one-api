...
var ModelRatio = map[string]float64{
	...
	"wanx-v1":                       8.00,
	"deepseek-r1":                   0.003 * RMB,  // 成本 ¥0.002 * 1.5 = ¥0.003/1k tokens
	"deepseek-v3":                   0.0015 * RMB, // 成本 ¥0.001 * 1.5 = ¥0.0015/1k tokens
	"deepseek-r1-distill-qwen-1.5b": 0.0015 * RMB, // 成本 ¥0.001 * 1.5
	"deepseek-r1-distill-qwen-7b":   0.00075 * RMB, // 成本 ¥0.0005 * 1.5
	"deepseek-r1-distill-qwen-14b":  0.0015 * RMB, // 成本 ¥0.001 * 1.5
	"deepseek-r1-distill-qwen-32b":  0.003 * RMB,  // 成本 ¥0.002 * 1.5
	"deepseek-r1-distill-llama-8b":  0.00075 * RMB, // 成本 ¥0.0005 * 1.5
	"deepseek-r1-distill-llama-70b": 0.006 * RMB,  // 成本 ¥0.004 * 1.5
	"deepseek-v4-flash":            0.000765 * RMB, // 平均成本 ¥0.51/1M = ¥0.00051/1k * 1.5
	"deepseek-v4-pro":              0.002268 * RMB, // 平均成本 ¥1.5125/1M = ¥0.0015125/1k * 1.5
	...
	// 定价为 API 成本的 1.5 倍
	"deepseek-chat":     0.21 * MILLI_USD,  // 成本 $0.14 * 1.5 = $0.21/1M tokens
	"deepseek-reasoner": 0.825 * MILLI_USD, // 成本 $0.55 * 1.5 = $0.825/1M tokens
...
var CompletionRatio = map[string]float64{
	...
	"deepseek-v4-flash":  2 / 1,  // 输出 ¥2/1M ÷ 输入 ¥1/1M = 2
	"deepseek-v4-pro":    6 / 3,  // 输出 ¥6/1M ÷ 输入 ¥3/1M = 2
}
